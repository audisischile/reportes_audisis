  ...
  <div class="row align-items-center me-1">
    ...
    <div class="col-7 p-3" style="background-color: #E8E8E8;">
      <div class="row d-flex justify-content-center align-items-center">
        ...
        <div class="col-2">
          <button class="btn mt-4" style="border-radius: 0;margin-left: -1em ; background-color: #ED3632; border-color: #BA0011; color: white;"
      ...
      <div class="row mt-3">
        <div class="col-4">
          <select class="form-select w-100 filtro-select botonera" v-model="useStore.cadenaSeleccionada">
            ...
            <option v-for="item in useStore.cadenas" :value="item.FK_Cadena_ID_cadena">{{ item.NombreCadenaReal }}
            </option>
          </select>
        </div>
        <div class="col-4">
